...
void test_functions(void** Functions, string(&function_names)[7])
{
	...
	for (int ND = 0; ND < 4; ND++)
	{
		...
		{
		case 0:
			cout << "\n----------20000 elements of arrray----------" << endl;
			break;
		case 1:
			cout << "\n----------30000 elements of arrray----------" << endl;
			break;
		case 2:
			cout << "\n----------40000 elements of arrray----------" << endl;
			break;
		case 3:
			cout << "\n----------50000 elements of arrray----------" << endl;
			break;
		default:
			break;
		}
...
int main() {
	...
	string function_names[7]{ "Bubble sort(consistent)", "OddEven sort(consistent)", "OddEven sort(parallel)", "Shell sort(consistent)", "Shell sort(parallel)",
							"Quick sort(consistent)", "Quick sort(parallel)" };
	cout << "---------------------------TYPE INT---------------------------" << endl;
