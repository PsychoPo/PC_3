...
char* inBMP(int i) {
    string str;
    str = "c:\\users\\whoami\\source\\repos\\parallel computing\\lab_3\\input_X.bmp";
    char* cstr;
    switch (i)
    {
    case 1:
...
char* outBMP(int i, int alg) {
    string str;
    str = "C:\\Users\\whoami\\source\\repos\\Parallel Computing\\lab_3\\output_X_Y.bmp";
    char* cstr;
    switch (i)
    {
    case 1:
...
int main()
{
    ...
    string function_names[6]{ "Median Filter(shell sort)", "Median Filter(shell sort sections)",
        "Median Filter(shell sort parallel for)", "Median Filter(quick sort)", "Median Filter(quick sort sections)",
        "Median Filter(quick sort parallel for)" };
